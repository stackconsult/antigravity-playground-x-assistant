...
This repository contains the **CEO Assistant Operational System**, an automated
Executive Assistant built on the Antigravity Framework. It combines a
rules-based decision engine with a desktop "Command Center" dashboard.
...
- **Real Integrations:** Connects to **Gmail** and **Google Calendar** via
  OAuth2.
...
This generates a standalone installer (e.g., `.dmg`, `.exe`) in the `dist/`
folder.
...
2. **Configure Google Cloud:**
   ...
   - **Option B (Production):** Launch the app (`npm start`), go to **Settings**,
     and enter your Client ID/Secret directly.
